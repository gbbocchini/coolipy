...
class TestCoolifyApiBase(unittest.TestCase):
    ...
    def test_handle_response_successful_single(self):
        ...
        result = self.api_base._handle_response(mock_response, COOLIFY_RETURN_TYPES.single, mock_model)
    ...
    def test_handle_response_successful_list(self):
        ...
        result = self.api_base._handle_response(mock_response, COOLIFY_RETURN_TYPES.list, mock_model)
